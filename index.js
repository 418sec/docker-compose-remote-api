...
module.exports = function(options) {
    ...
    return {
        ...
        build: function(fnStdout, fnStderr, fnExit){
            var execDockerCompose  = execFile("docker-compose", ["build"], { cwd: cwd });
        ...
        create: function(fnStdout, fnStderr, fnExit){
            var execDockerCompose  = execFile("docker-compose", ["create", "--force-recreate", "--build"], { cwd: cwd });
            execDockerCompose.stdout.on('data', function(data) { if(typeof fnStdout == "function") fnStdout(data.toString()); });
            execDockerCompose.stderr.on('data', function(data) { if(typeof fnStderr == "function") fnStderr(data.toString()); });
            execDockerCompose.on("exit", fnExit);
        },
        ...
        down: function(fnStdout, fnStderr, fnExit){
            var execDockerCompose  = execFile("docker-compose", ["down", "--remove-orphans"], { cwd: cwd });
            execDockerCompose.stdout.on('data', function(data) { if(typeof fnStdout == "function") fnStdout(data.toString()); });
            execDockerCompose.stderr.on('data', function(data) { if(typeof fnStderr == "function") fnStderr(data.toString()); });
            execDockerCompose.on("exit", fnExit);
        },
        ...
        exec: function(serviceName, cmd, fnStdout, fnStderr, fnExit){
            var execDockerCompose  = execFile("docker-compose", ["exec", serviceName, cmd], { cwd: cwd });
            execDockerCompose.stdout.on('data', function(data) { if(typeof fnStdout == "function") fnStdout(data.toString()); });
            execDockerCompose.stderr.on('data', function(data) { if(typeof fnStderr == "function") fnStderr(data.toString()); });
            execDockerCompose.on("exit", fnExit);
        },
        ...
        kill: function(serviceName, fnStdout, fnStderr, fnExit){
            var execDockerCompose  = execFile("docker-compose", ["kill", "-s", "SIGINT", serviceName], { cwd: cwd });
            execDockerCompose.stdout.on('data', function(data) { if(typeof fnStdout == "function") fnStdout(data.toString()); });
            execDockerCompose.stderr.on('data', function(data) { if(typeof fnStderr == "function") fnStderr(data.toString()); });
            execDockerCompose.on("exit", fnExit);
        },
        ...
        restart: function(serviceName, fnStdout, fnStderr, fnExit){
            var execDockerCompose  = execFile("docker-compose", ["restart", serviceName], { cwd: cwd });
            execDockerCompose.stdout.on('data', function(data) { if(typeof fnStdout == "function") fnStdout(data.toString()); });
            execDockerCompose.stderr.on('data', function(data) { if(typeof fnStderr == "function") fnStderr(data.toString()); });
            execDockerCompose.on("exit", fnExit);
        },
        ...
        rm: function(serviceName, fnStdout, fnStderr, fnExit){
            var execDockerCompose  = execFile("docker-compose", ["rm", "-f", serviceName], { cwd: cwd });
            execDockerCompose.stdout.on('data', function(data) { if(typeof fnStdout == "function") fnStdout(data.toString()); });
            execDockerCompose.stderr.on('data', function(data) { if(typeof fnStderr == "function") fnStderr(data.toString()); });
            execDockerCompose.on("exit", fnExit);
        },
        ...
        run: function(serviceName, cmd, fnStdout, fnStderr, fnExit){
            var execDockerCompose  = execFile("docker-compose", ["run", serviceName, cmd], { cwd: cwd });
            execDockerCompose.stdout.on('data', function(data) { if(typeof fnStdout == "function") fnStdout(data.toString()); });
            execDockerCompose.stderr.on('data', function(data) { if(typeof fnStderr == "function") fnStderr(data.toString()); });
            execDockerCompose.on("exit", fnExit);
        },
        ...
        ps: function(cb){
            var ps = "";
            var execDockerCompose = execFile("docker-compose", ["ps"], { cwd: cwd });
        ...
        up: function(fnStdout, fnStderr, fnExit){
            var execDockerCompose = execFile("docker-compose", ["up", "-d", "--remove-orphans"], { cwd: cwd });
            execDockerCompose.stdout.on('data', function(data) { if(typeof fnStdout == "function") fnStdout(data.toString()); });
            execDockerCompose.stderr.on('data', function(data) { if(typeof fnStderr == "function") fnStderr(data.toString()); });
            execDockerCompose.on("exit", fnExit);
        },
    ...
    function RemoteAPIModel(options){ 
        return {
            ...
            getContainerId: function(containerName, fn){
                execFile("docker-compose", ["ps", "-q", containerName], { cwd: options.cwd }, function(err, stdout, stderr){
                    if(err) fn(err, null);
